    ...
    public function update(Request $request, $id)
    {
        try {
            $request->validate([
                ...
                'image.max' => __('The banner image must be 5 MB or smaller. Please compress it and try again.'),
                'image.uploaded' => __('The banner image is too large to upload (server limit 5 MB). Please compress it and try again.'),
                'image.mimes' => __('The banner image must be a JPG, PNG, GIF or SVG file.'),
            ]);
