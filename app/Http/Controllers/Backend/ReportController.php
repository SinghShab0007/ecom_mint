    ...
    public function customerReportList(Request $request)
    {
        ...
        foreach ($records as $record) {
            $data_arr[] = array(
                ...
                // The buyer may have been deleted since ordering, so fall back to
                // the details denormalised onto the order row itself.
                "last_name" => $record->customer
                    ? $record->customer->full_name()
                    : trim($record->user_first_name . ' ' . $record->user_last_name),
                "mobile" => $record->customer ? $record->customer->mobile : $record->user_mobile,
                "email" => $record->customer ? $record->customer->email : $record->user_email,
