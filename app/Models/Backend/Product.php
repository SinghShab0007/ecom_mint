...
class Product extends Model
{
    ...
    protected $fillable = ['seller_id', 'category_id', 'brand_id', 'name', 'unit', 'tags', 'minimum_qty', 'barcode', 'sku', 'is_refundable', 'attributes', 'unit_price', 'purchase_price', 'sale_price', 'discount', 'quantity', 'shipping_cost', 'outside_shipping_cost', 'description', 'short_description', 'specification_content', 'specification_items', 'pdf_specification', 'meta_title', 'meta_description', 'meta_image', 'slug', 'total_viewed', 'is_active', 'publish_stat', 'warranty', 'return_policy', 'wholesale_status'];
