...
class Product extends Model
{
    ...
    protected $fillable = [
        'name', 'category_id', 'brand_id', 'barcode', 'unit', 'minimum_qty', 'tags', 'courieres', 'is_refundable', 'attributes', 'unit_price', 'slug', 'sku', 'purchase_price', 'discount', 'discount_type', 'quantity', 'description', 'short_description', 'specification_content', 'specification_items', 'pdf_specification', 'meta_title', 'meta_description', 'meta_image', 'is_active', 'publish_stat', 'created_by', 'updated_by', 'deleted_by', 'shipping_cost', 'outside_shipping_cost', 'seller_id', 'sale_price', 'warranty', 'is_flash_deal', 'return_policy'
    ];
