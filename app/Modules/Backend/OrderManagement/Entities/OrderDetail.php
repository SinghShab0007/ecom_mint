...
class OrderDetail extends Model
{
    ...
    protected $fillable = [
        'seller_id','user_id','order_id','order_stat', 'courier', 'product_id','sale_price','color','size','qty','discount','tax', 'shipping_cost','total_shipping_cost','total_price','grand_total','currency_id','exchange_rate','inside_shipping_days', 'outside_shipping_days'
    ];
