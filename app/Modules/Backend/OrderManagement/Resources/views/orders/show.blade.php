...
@section('content')
    <div class="content-body">
                                                    ...
                                                    <td>
                                                        <div class="invoice-title">
                                                            <h6>
                                                                ...
                                                                @elseif (optional($detail->orderStatus)->name == 'RETURN REQUESTED')
                                                                    <span class="badge bg-warning text-dark">{{ $detail->orderStatus->name ?? '' }}</span>
        ...
        <!-- Modal -->
        <div class="modal fade" id="sellerInvoice" tabindex="-1" aria-labelledby="sellerInvoiceLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <path d="M42.5,19.408H40V1.843c0-0.69-0.561-1.25-1.25-1.25H6.25C5.56,0.593,5,1.153,5,1.843v17.563H2.5   c-1.381,0-2.5,1.119-2.5,2.5v20c0,1.381,1.119,2.5,2.5,2.5h40c1.381,0,2.5-1.119,2.5-2.5v-20C45,20.525,43.881,19.408,42.5,19.408z    M32.531,38.094H12.468v-5h20.063V38.094z M37.5,19.408H35c-1.381,0-2.5,1.119-2.5,2.5v5h-20v-5c0-1.381-1.119-2.5-2.5-2.5H7.5   V3.093h30V19.408z M32.5,8.792h-20c-0.69,0-1.25-0.56-1.25-1.25s0.56-1.25,1.25-1.25h20c0.689,0,1.25,0.56,1.25,1.25   S33.189,8.792,32.5,8.792z M32.5,13.792h-20c-0.69,0-1.25-0.56-1.25-1.25s0.56-1.25,1.25-1.25h20c0.689,0,1.25,0.56,1.25,1.25   S33.189,13.792,32.5,13.792z M32.5,18.792h-20c-0.69,0-1.25-0.56-1.25-1.25s0.56-1.25,1.25-1.25h20c0.689,0,1.25,0.56,1.25,1.25   S33.189,18.792,32.5,18.792z"></path>
                            ...
                            @php
                                ...
                                $orderCountry = $meta['country'] ?? ($order->country->name ?? 'India');
                            @endphp
                                    ...
                                    <div class="col-6">
                                        <div class="billing-info">
                                            ...
                                            <ul>
                                                ...
                                                <li><span>{{__('City')}}:</span>{{ $order->user_city ?? ($billingMeta['city'] ?? '') }}</li>
                                                @if(!empty($billingMeta['district']))
                                                    <li><span>{{__('District')}}:</span>{{ $billingMeta['district'] }}</li>
                                                @endif
                                                @if(!empty($billingMeta['state']))
                                                    <li><span>{{__('State')}}:</span>{{ $billingMeta['state'] }}</li>
                                                @endif
                                                <li><span>{{__('Pincode')}}:</span>{{ $order->user_post_code ?? ($billingMeta['pincode'] ?? '') }}</li>
                                                <li><span>{{__('Country')}}:</span>{{ $orderCountry }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="billing-info">
                                            ...
                                            <ul>
                                                <li><span>{{__('Name')}}:</span>{{ $order->shipping_name ?? $order->full_name() }}</li>
                                                @if($order->shipping_mobile)
                                                    <li><span>{{__('Phone')}}:</span>{{ $order->shipping_mobile }}</li>
                                                @endif
                                                <li><span>{{__('Address')}}:</span>{{ $order->shipping_address_1 }}</li>
                                                <li><span>{{__('City')}}:</span>{{ $order->shipping_town ?? ($shippingMeta['city'] ?? '') }}</li>
                                                @if(!empty($shippingMeta['district']))
                                                    <li><span>{{__('District')}}:</span>{{ $shippingMeta['district'] }}</li>
                                                @endif
                                                @if(!empty($shippingMeta['state']))
                                                    <li><span>{{__('State')}}:</span>{{ $shippingMeta['state'] }}</li>
                                                @endif
                                                <li><span>{{__('Pincode')}}:</span>{{ $order->shipping_post ?? ($shippingMeta['pincode'] ?? '') }}</li>
                                                <li><span>{{__('Country')}}:</span>{{ $orderCountry }}</li>
                                            </ul>
                                        </div>
                                    </div>
