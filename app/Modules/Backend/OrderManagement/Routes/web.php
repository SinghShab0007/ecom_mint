...
Route::group(['prefix' => 'admin', 'as' => 'backend.'], function () {
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('return_request_list', 'OrderController@returnRequestList')->name('return_requests.list');
        Route::post('return/approve', 'OrderController@approveReturn')->name('return.approve');
        Route::post('return/reject', 'OrderController@rejectReturn')->name('return.reject');
        ...
        Route::group(['middleware' => ['check_permission']], function () {
            ...
            Route::get('return_requests', 'OrderController@returnRequests')->name('return_requests');
        });
    });
