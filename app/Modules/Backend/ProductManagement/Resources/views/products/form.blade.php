    ...
    <div class="add-product-form">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="sm-title-group">
                    <div class="input-group overflow-visible">
                        <select name="tags[]" multiple="multiple" class="tags form-select" aria-label="Select Tags">
            ...
            <div class="col-lg-4">
                <div class="sm-title-group">
                    <div class="input-group overflow-visible">
                        <select name="courieres[]" multiple="multiple" class="courieres form-select" aria-label="Select courieres">
                        ...
                        <select name="seller_id"
                            ...
                            @foreach ($sellers as $seller)
                                <option value="{{ $seller->id }}"
                                    @if ($seller->id == $product->seller_id) selected @endif>{{ $seller->company_name ?? '' }}
                                </option>
                            @endforeach
                        </select>
                        @error('seller_id')
...
<div class="container bg-tr">
    <div class="row">
        <div class="col-lg-8 center-content">
                    ...
                    <div class="accordion mb-4" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button text-center font-weight-bold d-inline-block" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    {{ __('Do you want to add variation for this product?') }}
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse {{ $product->productstock ? 'show':'' }}" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="d-flex justify-content-between mb-3">
                                        <h5>{{ __('Variation wise stock') }}</h5>
                                        <button type="button" class="btn btn-warning btn-sm base-bg text-light another-variation"><i class="fa fa-plus-circle d-inline-block mt-1" aria-hidden="true"></i></button>
                                    </div>
                                    <div class="variants">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter quantity" name="quantities[]" value="{{ $productstock->quantities }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <p>{{ __('Shipping Cost(Inside India)') }}</p>
                        </div>
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                        ...
                        <div class="col-lg-4">
                            <p>{{ __('Shipping Cost(Outside India)') }}</p>
                        </div>
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                        ...
                        <div class="col-lg-8">
                            <div class="sm-title-group">
                                <div class="input-group">
                                    <select name="attributes[]" multiple="multiple" class="attributes form-select" aria-label="Select Attribute">
                                        <option value="">Select Attribute</option>
            ...
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('Product short description') }}</h5>
                </div>
                <div class="card-body">
                    <p class="text-muted small mb-2">{{ __('Shown below the product name on the storefront. Plain text; line breaks are preserved.') }}</p>
                    <div class="row">
                        <div class="col-lg-12">
                            <textarea name="short_description" class="form-control" rows="4" placeholder="{{ __('Short summary for customers…') }}">{{ old('short_description', $product->short_description) }}</textarea>
                        </div>
                    </div>
                    <br>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('Each row: label (left) and value (right), like Brand: INDIAN TERRAIN. Shown on the storefront Specifications tab.') }}</p>
                    @php
                        $specificationRows = old('specification_items');
                        if ($specificationRows === null || ! is_array($specificationRows)) {
                            $specificationRows = $product->specification_items;
                            if (! is_array($specificationRows)) {
                                $specificationRows = [];
                            }
                        }
                    @endphp
                    @include('productmanagement::products.partials.specification-items', ['rows' => $specificationRows])
                    @if ($product->pdf_specification && count($product->specification_items ?? []) === 0 && empty($product->specification_content))
                    <div class="row mt-3">
                        <div class="col-12">
                            <p class="small text-muted mb-1">{{ __('Previously uploaded PDF (legacy)') }}</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                <textarea name="meta_description" class="form-control"> @if ($product->meta_description) {{ $product->meta_description }}@else{{ old('meta_description') }}@endif</textarea>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <p>{{ __('Meta Image') }}</p>
        ...
        <div class="col-lg-4 sidebar-items">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="date" value="{{optional($product->details)->flash_start_at}}" name="flash_start_at" class="form-control">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label>{{__('End Date')}}</label>
                                <input type="date" value="{{optional($product->details)->flash_end_at}}" name="flash_end_at" class="form-control"/>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="mb-0">{{ __('Inside India') }} <span class="text-red">*</span></p>
                    <div class="input-group month overflow-visible mb-3">
                        <select name="inside_shipping_days" class="form-select form-control" required>
                            <option value="">{{ __('Select Shipping(Inside India)') }}</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("input[name='discount']").change(function () {
                $("input[name='discount']").attr('max', parseInt($("input[name='unit_price']").val()) || null);
            });
