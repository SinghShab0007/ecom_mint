...
<div class="container">
    <div class="add-product-form">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="add-input overflow-visible">
                    <input id="name" type="text" class="form-control" name="name" placeholder="Product Name" value="{{ $product->name ?? '' }}" autofocus required>
                </div>
            </div>
            <div class="col-lg-2">
            ...
            <div class="col-lg-4">
                <div class="input-group add-input overflow-visible">
                    ...
                    <a class="btn-clone text-center" type="button"
                        href="{{ route('backend.categories.create') }}">+</a>
                    @error('category_id')
            ...
            <div class="col-lg-4">
                <div class="sm-title-group">
                    <div class="input-group overflow-visible">
                        <select class="form-control tags {{ $errors->has('tags') ? ' is-invalid' : '' }}" multiple="multiple" name="tags[]" autofocus>
                            @foreach ($tags ?? [] as $tg)
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    <div class="form-check form-switch btn-one-off">
                        ...
                        <input name="is_refundable" @if ($product->is_refundable || old('is_refundable')) checked @endif
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        <select name="seller_id"
                            class="seller form-select form-control{{ $errors->has('seller_id') ? ' is-invalid' : '' }}"
                            required>
                            <option value="">{{ __('Select Seller') }}</option>
                            @foreach ($sellers as $key => $seller)
                                <option value="{{ $seller->id }}"
                                    @if ($seller->id == $product->seller_id || $seller->id == old('seller_id')) selected @endif>{{ $seller->company_name ?? '' }}
                                </option>
                            @endforeach
                        </select>
                        @error('seller_id')
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                <select name="size[]" class="form-select size" multiple="multiple" aria-label="Nothing selected">
                                    <option value="">{{ __('Select Size') }}</option>
                                    @if ($product)
                                    @foreach ($sizes as $key => $sz)
                                        <option value="{{ $sz->id }}"
                                            @if ($product->sizes()->exists() && in_array($sz->id, $product->sizes()->pluck('sizes.id')->toArray())) selected @endif>{{ $sz->name }}
                                        </option>
                                    @endforeach
                                    @else
                                    @foreach ($sizes as $key => $sz)
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                                <input name="purchase_price" min="0" type="number" value="{{ $product->purchase_price }}" class="form-control" placeholder="0" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group overflow-visible">
                                <input name="shipping_cost" min="0" type="number" class="form-control{{ $errors->has('shipping_cost') ? ' is-invalid' : '' }}" placeholder="0" value="{{ $product->shipping_cost }}" required>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4 sidebar-items">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_free_shipping" value="1" class="form-check-input"
                                    @if (($product->details && $product->details->is_free_shipping) || old('is_free_shipping') == 1) checked @endif type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                            <p>{{ __('Flat Rate') }}</p>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_flat_rate" value="1" class="form-check-input"
                                    @if (($product->details && $product->details->is_flat_rate) || old('is_flat_rate') == 1) checked @endif type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_product_wise_shipping" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_product_wise_shipping) checked @endif type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_quantity_multiply" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_quantity_multiply) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input name="warning_quantity" type="number" class="form-control" min="1" value="{{ optional($product->details)->warning_quantity }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_show_stock_quantity" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_show_stock_quantity) checked @endif
                                    @if (Request::is('admin/products/create')) checked @endif type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_show_stock_with_text_only" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_show_stock_with_text_only) checked @endif type="checkbox">
                            </div>
                        </div>
                        <div class="col-9">
                            <p>{{ __('Hide Stock') }}</p>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_hide_stock" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_hide_stock) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_cash_on_delivery" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_cash_on_delivery) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_featured" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_featured) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_best_sell" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_best_sell) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3">
                            <div class="form-switch">
                                ...
                                <input name="is_todays_deal" value="1" class="form-check-input"
                                    @if ($product->details && $product->details->is_todays_deal) checked @endif type="checkbox">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="mb-0">{{ __('Add To Flash') }}</p>
                    <div class="mb-3">
                        <input name="flash_deal_title" type="text" class="form-control @error('flash_deal_title') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        <input name="flash_deal_discount" type="number" min="0" value="@if ($product->details && $product->details->flash_deal_discount) {{ $product->details->flash_deal_discount ?? '' }}@else{{ old('flash_deal_discount') }} @endif"
                    ...
                    <p class="mb-0">{{ __('Discount Type') }}</p>
                    <div class="mb-3">
                        <select name="flash_deal_discount_type" class="form-select form-control @error('flash_deal_discount_type') is-invalid @enderror">
                            <option value="">{{ __('Choose Discount Type') }}</option>
                            <option value="flat" @if (
                                ($product->details && $product->details->flash_deal_discount_type == 'flat') ||
                                    old('flash_deal_discount_type') == 'flat') selected @endif>
                                Flat
                            </option>
                            <option value="percent" @if (
                                ($product->details && $product->details->flash_deal_discount_type == 'percent') ||
                                    old('flash_deal_discount_type') == 'percent') selected @endif>
                                Percent
                            </option>
                        </select>
                        @error('flash_deal_discount_type')
                            <label id="flash_deal_discount_type-error" class="error" for="flash_deal_discount_type">{{ $message }}</label>
                        @enderror
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="input-group month overflow-visible">
                        ...
                        <select name="inside_shipping_days"
                            ...
                            <option value="3-7 days" @if (
                                ($product->details && $product->details->inside_shipping_days == '3-7 days') ||
                                    old('inside_shipping_days') == '3-7 days') selected @endif>
                                3-7 days
                            </option>
                            <option value="3-15 days" @if (
                                ($product->details && $product->details->inside_shipping_days == '3-15 days') ||
                                    old('inside_shipping_days') == '3-15 days') selected @endif>
                                3-15 days
                            </option>
                            <option value="7-15 days" @if (
                                ($product->details && $product->details->inside_shipping_days == '7-15 days') ||
                                    old('inside_shipping_days') == '7-15 days') selected @endif>
                                7-15 days
                            </option>
                            <option value="7-30 days" @if (
                                ($product->details && $product->details->inside_shipping_days == '7-30 days') ||
                                    old('inside_shipping_days') == '7-30 days') selected @endif>
                                7-30 days
                            </option>
                        </select>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <p>{{ __('Vat') }} </p>
                            <div class="input-group ">
                                <input name="vat" min="0" type="number" class="form-control" value="{{ optional($product->details)->vat }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <p>{{ __('Tax') }} </p>
                            <div class="input-group">
                                <input name="tax" type="number" min="0" class="form-control" value="{{ optional($product->details)->tax }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-group ">
                                <select name="publish_stat" class="form-control form-select">
                                    ...
                                    <option value="0" @if ($product->publish_stat == 0) selected @endif>
                                        {{ __('UnPublish') }}</option>
                                    <option value="1" @if ($product->publish_stat == 1) selected @endif>
                                        {{ __('Draft') }}</option>
                                    <option value="2" @if ($product->publish_stat == 2) selected @endif>
                                        {{ __('Published') }}</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="from-all-btn">
                @if (Request::is('admin/products/create', 'seller/products/create'))
                    <input class="submit-btn save" type="submit" name="is_draft" value="Save As Draft">
                    <input class="submit-btn save-unpublis" type="submit" name="is_unpublish" value="Save & Unpublish">
                    <input class="submit-btn save-publis" type="submit" name="is_publish" value="Save & Publish">
                @else
