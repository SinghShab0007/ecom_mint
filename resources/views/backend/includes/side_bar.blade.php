    ...
    <div class="side-bar-manu">
        <ul>
            ...
            @if (Module::has('OrderManagement') && Module::find('OrderManagement')->isEnabled())
                @if (auth()->user()->can('browse_order_management') ||
                    ...
                    <li class="@if (Request::is('admin/*_orders', 'admin/orders', 'admin/orders/*')) active @endif ">
                        ...
                        <ul>
                            @if (auth()->user()->can('browse_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('browse_pending_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                            ...
                            @endif
                            @if (auth()->user()->can('browse_confirmed_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('browse_processing_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('browse_picked_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('browse_shipped_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                            ...
                            @endif
                            @if (auth()->user()->can('browse_delivered_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                            ...
                            @endif
                            @if (auth()->user()->can('browse_cancelled_orders') ||
                                    auth()->user()->hasRole('super-admin'))
                            ...
                            @endif
                            @if (auth()->user()->can('browse_return_requests') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li><a class="@if (Request::is('admin/return_requests')) active @endif"
                                       href="{{ route('backend.return_requests') }}">
                                        {{ __('Returns') }}
            ...
            @if (Module::has('ProductManagement') && Module::find('ProductManagement')->isEnabled())
                @if (auth()->user()->can('browse_product_management') ||
                        auth()->user()->hasRole('super-admin'))
                    <li class="@if (Request::is(
                            ...
                            'admin/products/wholesale')) active @endif">
                        <a href="#">
                            <span class="icon">
                        ...
                        <!-- Sub Manu Start -->
                        <ul>
                            @if (auth()->user()->can('browse_products') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('flash_deal') ||
                                auth()->user()->hasRole('super-admin'))
                                <li>
                                    <a class="@if (Request::is('admin/products/flash-deal')) active @endif"
                                       href="{{ route('backend.products.flash-deal') }}">{{ __('Flash Deal') }}</a>
                                </li>
                            @endif
                            @if (auth()->user()->can('browse_categories') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @if (auth()->user()->can('create_categories') || auth()->user()->hasRole('super-admin'))
                                <li>
                                    <a class="@if (Request::is('admin/categories/create')) active @endif"
                                       href="{{ route('backend.categories.create') }}"> {{ __('Add Category') }}
                                    </a>
                                </li>
                            @endif
                            @if (auth()->user()->can('manage_commissions') || auth()->user()->hasRole('super-admin'))
                                <li>
                                    <a class="@if (Request::is('admin/commissions')) active @endif"
                                       href="{{ route('backend.commissions.index') }}"> {{ __('Commissions') }}
                                    </a>
                                </li>
                            @endif
                            ...
                            @endif
                                @if(auth()->user()->can('browse_colors') || auth()->user()->hasRole('super-admin'))
                                    <li><a class="@if(Request::is('admin/colors','admin/colors/*/edit'))active @endif"
                                           href="{{route('backend.colors.index')}}"> {{ __('Color') }} </a>
                                    </li>
                                @endif
                                @if(auth()->user()->can('create_colors') || auth()->user()->hasRole('super-admin'))
                                    <li><a class="@if(Request::is('admin/colors/create'))active @endif"
                                           href="{{route('backend.colors.create')}}"> {{ __('Add Color') }} </a>
                                    </li>
                                @endif
                                @if(auth()->user()->can('browse_sizes') || auth()->user()->hasRole('super-admin'))
                                    <li><a class="@if(Request::is('admin/sizes','admin/sizes/*/edit'))active @endif"
                                           href="{{route('backend.sizes.index')}}"> {{ __('Size') }} </a>
                                    </li>
                                @endif
                                @if(auth()->user()->can('create_sizes') || auth()->user()->hasRole('super-admin'))
                                    <li><a class="@if(Request::is('admin/sizes/create'))active @endif"
                                           href="{{route('backend.sizes.create')}}"> {{ __('Add Size') }} </a>
                                    </li>
                                @endif
            ...
            @if (Module::has('PromotionManagement') && Module::find('PromotionManagement')->isEnabled())
                @if (auth()->user()->can('browse_promotion_management') ||
                    ...
                    <li class="@if (Request::is('admin/promotional_products', 'admin/promotional_products/*', 'admin/coupon*')) active @endif">
                        ...
                        <!-- Sub Manu Start -->
                        <ul>
                            @if (auth()->user()->can('browse_promotional_products') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('create_promotional_products') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                            ...
                            @endif
                            @if (auth()->user()->can('browse_coupon') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
                                    <a class="@if (Request::is('admin/coupon*')) active @endif"
                                       href="{{ route('backend.coupon.index') }}"> {{ __('Coupons') }} </a>
                                </li>
                            @endif
                        </ul>
                        <!-- Sub Manu End -->
            ...
            @if (Module::has('CustomerManagement') && Module::find('CustomerManagement')->isEnabled())
                @if (auth()->user()->can('browse_customer_management') ||
                        auth()->user()->hasRole('super-admin'))
                    <li class="@if (Request::is(
                            'admin/customers',
                            'admin/customers/*',
                            ...
                            'seller/email_subscriber')) active @endif">
                        ...
                        <!-- Sub Manu Start -->
                        <ul>
                            @if (auth()->user()->can('browse_customers') ||
                                    auth()->user()->hasRole('super-admin'))
                                <li>
            ...
            @if (Module::has('SellerManagement') && Module::find('SellerManagement')->isEnabled())
                @if (auth()->user()->can('browse_seller_management') ||
                        auth()->user()->hasRole('super-admin'))
            ...
            @if (auth()->user()->can('browse_faq_manager') ||
                ...
                <li class="@if (Request::is(
                        ...
                        'admin/faq_subcategory/*',
                        'admin/faq_content',
                        'admin/faq_content/*')) active @endif">
            ...
            @endif
            @if (auth()->user()->can('browse_user_permission') ||
                    auth()->user()->hasRole('super-admin'))
                <li class="@if (Request::is(
                        'admin/permissions',
                        'admin/permissions/*',
                    ...
                    <ul>
                        ...
                        @endif
                        @if (auth()->user()->can('browse_permissions') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
            ...
            @endif
            @if (auth()->user()->can('browse_website_setting') ||
                    auth()->user()->hasRole('super-admin'))
                <li class="@if (Request::is(
                        'admin/contact-infos',
                        ...
                        'admin/website_setting/notice/*')) active @endif">
                    ...
                    <!-- Sub Manu Start -->
                    <ul>
                        @if (auth()->user()->can('browse_header') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
                        ...
                        @endif
                        @if (auth()->user()->can('browse_appearance') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
                        ...
                        @endif
                        @if (auth()->user()->can('browse_announcements') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
                        ...
                        @if (auth()->user()->can('browse_currency') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
                        ...
                        @endif
                        @if (auth()->user()->can('browse_language') ||
                                auth()->user()->hasRole('super-admin'))
                            <li>
                                <a class="@if (Request::is('admin/website_setting/language', 'admin/website_setting/language/*')) active @endif"
                                   href="{{ route('backend.language.index') }}">{{ __('Language') }}
                                </a>
                            </li>
                        @endif
                        @if (auth()->user()->can('browse_notice') || auth()->user()->hasRole('super-admin'))
                            <li>
                                <a class="@if (Request::is('admin/website_setting/notice', 'admin/website_setting/notice/*')) active @endif"
                                   href="{{ route('backend.notice.index') }}">{{ __('notice') }}
                                </a>
                            </li>
                        @endif
            ...
            @endif
            @if (auth()->user()->can('browse_payment_gateway') ||
                    auth()->user()->hasRole('super-admin'))
                <li>
                ...
                <li>
                    <a class="@if (Request::is('admin/payments*')) active @endif"
            ...
            @if (auth()->user()->can('browse_blog_list') || auth()->user()->hasRole('super-admin'))
                <li class="@if (Request::is('admin/blog/category', 'admin/blog/category/*', 'admin/blog', 'admin/blog/*')) active @endif">
                    ...
                    <ul>
                        <li>
                            <a class=" @if (Request::is('admin/blog/category', 'admin/blog/category/*')) active @endif"
                               href="{{ route('backend.blog.category.index') }}">{{ __('Blog Category') }}
                            </a>
                        </li>
                        <li>
                            <a class="@if (Request::is('admin/blog', 'admin/blog/*')) active @endif"
                               href="{{ route('backend.blog.index') }}">{{ __('blog') }}
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @if (auth()->user()->can('browse_stock_management') || auth()->user()->hasRole('super-admin'))
                <li class="@if (Route::is('backend.stocks.index') || Route::is('backend.stocks.show')) active @endif">
                    ...
                    <ul>
                        <li>
                            <a class="@if (Route::is('backend.stocks.index') || Route::is('backend.stocks.show')) active @endif"
                               href="{{ route('backend.stocks.index') }}">{{ __('Stock List') }}
                            </a>
                        </li>
                    </ul>
                </li>
