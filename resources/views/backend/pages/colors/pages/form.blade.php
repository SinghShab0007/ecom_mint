    ...
    <div class="col-lg-7">
        <div class="input-group">
            <input name="name" type="text" required
                   ...
                   value="@if($color->name){{$color->name}}@else{{ old('name') }}@endif"
    ...
    <div class="col-lg-7">
        <div class="input-group">
            <select name="is_active"
                ...
                <option value="1" @if($color->is_active==1) selected @endif>{{__('Active') }}</option>
                <option value="0" @if($color->is_active==0) selected @endif >{{__('Inactive')}}</option>
            </select>
    </div>
</div>
