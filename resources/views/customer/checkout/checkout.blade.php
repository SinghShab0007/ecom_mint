                                ...
                                <div class="checkout-form mt-4">
                                    ...
                                    <div class="mt-4 mb-3">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-6">
                                                <input type="radio" name="payment_method" id="payment_method_paydhara" class="d-none" checked="checked" value="Paydhara">
                                                <label for="payment_method_paydhara" class="payment-title"><i class="fa-solid fa-credit-card"></i> {{ __('Pay Online') }}</label>
                                            </div>
                                            @endif
                                            {{-- Cash on Delivery is always available, so checkout still works
                                                 when no online gateway is enabled. --}}
                                            <div class="{{ ($gatewayEnabled ?? false) ? 'col-6' : 'col-12' }}">
                                                <input type="radio" name="payment_method" id="payment_method_cod" class="d-none"
                                                       value="COD" @if(!($gatewayEnabled ?? false)) checked="checked" @endif>
                                                <label for="payment_method_cod" class="payment-title"><i class="fa-solid fa-hand-holding-dollar"></i> {{ __('Cash On Delivery') }}</label>
                                            </div>
                                        </div>
                                    </div>
