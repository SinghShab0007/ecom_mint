                ...
                <div class="top-bar-right">
                    <ul>
                        @guest
                            <li>
                                <a href="{{ url('/login') }}">
                                    <span class="text">{{ __('Customer Login') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/seller/login') }}">
                                    <span class="text">{{ __('Seller Login') }}</span>
                                </a>
                            </li>
                        @endguest
                        ...
                        @if(maanHeader('show_language'))
                            <li>
                                <div class="dropdown help-manu">
                                    <button class="dropdown-toggle" type="button" id="dropdownHelpManu" data-bs-toggle="dropdown" aria-expanded="false">{{ lang('name') }}</button>
