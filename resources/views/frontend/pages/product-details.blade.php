                        ...
                        <div class="col-lg-3 order-2 order-lg-0 product-small-img">
                            @foreach($product->images as $index => $image)
                                <div class="main-img product-thumb {{ $index === 0 ? 'active' : '' }}"
                                     ...
                                     style="cursor:pointer; border:2px solid {{ $index === 0 ? '#4C1D6B' : 'transparent' }}; border-radius:4px; margin-bottom:10px; transition:border-color .2s;">
            ...
            (function () {
                ...
                thumbs.forEach(function (thumb) {
                    thumb.addEventListener('click', function () {
                        ...
                        thumb.style.borderColor = '#4C1D6B';
                    });
                });
            })();
        </script>
