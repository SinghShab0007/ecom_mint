        ...
        <div class="row g-4 mb-5">
            <div class="col-md-4">
                <div class="info-tile">
                    ...
                    <h6>Call Us</h6>
                    <p>
                        <a href="tel:+919211635360">+91 9211635360</a><br>
            ...
            <div class="col-md-4">
                <div class="info-tile">
                    ...
                    <h6>Email Us</h6>
                    <p>
                        <a href="mailto:contact@billmintmall.com">contact@billmintmall.com</a><br>
            ...
            <div class="col-md-4">
                <div class="info-tile">
                    ...
                    <h6>Visit Us</h6>
                    <p>
                        Office No. S-01, 2nd floor, G-47, Sec-3,<br>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5">
                ...
                <div class="support-strip mb-4">
                    <h5 style="color:#0A0B2E;font-weight:700;margin-bottom:12px;">About BillMintMall</h5>
                    <p style="color:#6b7280;font-size:14px;line-height:1.8;margin:0;">
                        BillMintMall is a modern ecommerce platform powered by BILLMINT TECHNOLOGY PRIVATE LIMITED, focused on
