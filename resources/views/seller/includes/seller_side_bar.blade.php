        ...
        <ul>
            ...
            <li>
                <a href="{{ route('seller.account') }}">
                    ...
                    <span class="title">{{ __('Your Profile') }}</span>
                </a>
            </li>
            <li>
                <a href="#" onclick="event.preventDefault(); document.getElementById('seller-sidebar-logout-form').submit();">
                    <span class="icon">
                        <i class="fa-solid fa-right-from-bracket" aria-hidden="true"></i>
                    </span>
                    <span class="title">{{ __('Logout') }}</span>
                </a>
                <form id="seller-sidebar-logout-form" action="{{ route('seller.logout') }}" method="POST" style="display:none;">
                    @csrf
                </form>
            </li>
        </ul>
