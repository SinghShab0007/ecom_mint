    ...
    <div class="content-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="add-product" aria-labelledby="add-product-tab">
                <form id="productForm" class="add-brand-form ajaxform_instant_reload" action="{{ route('seller.product.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="container">
                        <div class="add-product-form">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        <input type="text" name="sku" class="form-control" placeholder="sku" value="{{ $sku }}">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <select name="inside_shipping_days" class="form-control" required>
                                                ...
                                                <option selected value="3-7 days"> 3-7 days </option>
                                                <option value="3-10 days"> 3-10 days </option>
                                                <option value="3-15 days"> 3-15 days </option>
                                        ...
                                        <div class="mb-3">
                                            <select name="outside_shipping_days" class="form-control" required>
                                                ...
                                                <option selected value="3-10 days"> 3-10 days </option>
                                                <option value="3-15 days"> 3-15 days </option>
                                                <option value="7-15 days"> 7-15 days </option>
                                                <option value="7-30 days"> 7-30 days </option>
                                            </select>
