            ...
            <div class="tab-pane fade show active" id="all-product" aria-labelledby="all-product-tab">
                <div class="container">
                    ...
                    <div class="content-table mt-0">
                        <div class="text-end">
                            <a href="{{route('seller.products.wholesale.form')}}" class=" btn btn add-more-btn-admin ">{{__('Add Wholesale')}}</a>
                        </div>
                                            ...
                                            @foreach($product->wholesales as $wholesale)
                                                <tr>
                                                    ...
                                                    <td class="w-120">
                                                        <ul>
                                                            <li>
                                                                <a class="p-0 action" href="{{route('seller.products.wholesale.edit',$wholesale->id)}}">
                                                                    <button title="Edit">
                                                            ...
                                                            <li>
                                                                <form action="{{route('seller.products.wholesale.destroy',$wholesale->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
        ...
        $(function() {
            ...
            $(document).on('click','.status', function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: public_path +'/seller/product/changeStatusWholesale',
