...
use App\Http\Controllers\Frontend\PincodeController;
...
Route::get('api/pincode/lookup',[PincodeController::class,'lookup'])->name('pincode.lookup');
Route::post('payment',[PaymentController::class,'index'])->name('customer.payment');
/* Literal paydhara routes must be declared before the {order} wildcard,
   otherwise "return" is captured as an order id and fails model binding. */
Route::get('payment/paydhara/return',[PaymentController::class,'paydharaReturn'])->name('customer.payment.paydhara.return');
Route::post('payment/paydhara/create',[PaymentController::class,'paydharaCreate'])->name('customer.payment.paydhara.create');
Route::post('payment/paydhara/status',[PaymentController::class,'paydharaStatus'])->name('customer.payment.paydhara.status');
Route::get('payment/paydhara/{order}',[PaymentController::class,'paydharaPage'])
    ->whereNumber('order')->name('customer.payment.paydhara.page');
...
Route::get('verify-email',[RegisterController::class,'showVerifyForm'])->name('customer.verification.show');
Route::post('verify-email',[RegisterController::class,'verifyOtp'])->name('customer.verification.verify');
Route::post('verify-email/resend',[RegisterController::class,'resendOtp'])->name('customer.verification.resend');
