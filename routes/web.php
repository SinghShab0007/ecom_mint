...
/* Paydhara gateway server-to-server webhook (no auth, CSRF excluded) */
Route::post('payment/paydhara/webhook', [App\Http\Controllers\Customer\PaymentController::class, 'paydharaWebhook'])->name('payment.paydhara.webhook');
