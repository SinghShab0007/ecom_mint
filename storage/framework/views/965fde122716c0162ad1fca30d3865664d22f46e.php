                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li>
                                <a href="<?php echo e(url('/login')); ?>">
                                    <span class="text"><?php echo e(__('Customer Login')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/seller/login')); ?>">
                                    <span class="text"><?php echo e(__('Seller Login')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(maanHeader('show_currency')): ?>
                            <li>
                                <div class="dropdown currency-manu">
                                    <button class="dropdown-toggle" type="button" id="dropdownCurrency" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span class="flag" id="cur-symbol"><?php echo e(userCurrency('symbol')); ?></span>
                                        <span class="flag-title" id="cur-title"><?php echo e(userCurrency('name')); ?></span>
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownCurrency">
                                        <?php $__currentLoopData = currencies(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <a href="javascript:changeCurrency(<?php echo e($currency->id); ?>)">
                                                    <span class=""><?php echo e($currency->symbol); ?>&nbsp;</span>
                                                    <span class="flag-title"><?php echo e($currency->name); ?></span>
                                                </a>
                                            </li>
                        ...
                        <?php if(maanHeader('show_language')): ?>
                            <li>
                                <div class="dropdown help-manu">
                                    <button class="dropdown-toggle" type="button" id="dropdownHelpManu" data-bs-toggle="dropdown" aria-expanded="false"><?php echo e(lang('name')); ?></button>
...
<!-- Top Bar End -->
<?php /**PATH /Users/himank/Developer/Development/Office_projects/Ecom_project/pays_ecom/billmint/resources/views/frontend/includes/top-bar.blade.php ENDPATH**/ ?>