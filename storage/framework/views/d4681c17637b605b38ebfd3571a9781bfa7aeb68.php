        ...
        <div class="row align-items-center">
			...
			c49.363,0,86.579,38.288,86.579,89.071C342.579,180.022,303.743,223.611,256,223.611z"/></svg>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownLogin">
                                    ...
                                    <?php else: ?>
                                        <li><a href="<?php echo e(url('/login')); ?>"><?php echo e(__('Customer Login')); ?></a></li>
...
<?php /**PATH /Users/himank/Developer/Development/Office_projects/Ecom_project/pays_ecom/billmint/resources/views/frontend/includes/mid-bar.blade.php ENDPATH**/ ?>