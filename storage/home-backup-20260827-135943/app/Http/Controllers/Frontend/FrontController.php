...
{
    /** Max products per category row on home (`_products` partial). */
    private const HOME_CATEGORY_PRODUCT_LIMIT = 20;

    /** Total product slots across all category rows on home (e.g. 7×20 + 10 = 150). */
    private const HOME_PAGE_CATEGORY_PRODUCTS_TOTAL_CAP = 150;
    ...
    public function index(): View
    {
        ...
        /** Home category rows: each category below gets up to HOME_CATEGORY_PRODUCT_LIMIT published products (see `_products` partial). */
