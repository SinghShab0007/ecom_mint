...
Route::get('payment/paysantspay/{order}',[PaymentController::class,'paysantsPayPage'])->name('customer.payment.paysantspay.page');
Route::post('payment/paysantspay/create',[PaymentController::class,'paysantsPayCreate'])->name('customer.payment.paysantspay.create');
Route::get('payment/paysantspay/return',[PaymentController::class,'paysantsPayReturn'])->name('customer.payment.paysantspay.return');
