            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="{{ url('/') }}"><img src="{{ asset('uploads') }}/{{ maanAppearance('logo') }}" alt="{{ config('app.name') }}"></a>
                    </div>
                    <p>{{ maanAppearance('about_us') }}</p>

                    <div style="color:var(--color-border); font-size:14px; line-height:1.9;">
                        <p style="margin:0 0 10px 0;">
                            Office No. D-242, Sector 63, Noida,<br>
                            Gautam Buddha Nagar, Uttar Pradesh 201307
                        </p>
                        <p style="margin:0 0 6px 0;">
                            <a href="tel:+919528070571" style="color:#c92f6d; text-decoration:none;">+91 9528070571</a>
                        </p>
                        <p style="margin:0;">
                            <a href="mailto:porosshoppvtltd@gmail.com" style="color:#c92f6d; text-decoration:none;">porosshoppvtltd@gmail.com</a>
                        </p>
                    </div>
                </div>
            </div>
