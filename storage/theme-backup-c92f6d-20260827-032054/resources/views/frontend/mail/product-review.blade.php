    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:560px; margin:24px auto;">
        ...
        <tr>
            <td style="padding:24px;">
                ...
                <div style="background:#fafafa; border-left:3px solid #c92f6d; padding:14px 18px; margin:0 0 24px 0; font-size:14px; line-height:1.6; color:#333;">
                    {{ $options['review_note'] }}
                </div>

                <table cellpadding="0" cellspacing="0" border="0" style="margin:0;">
                    <tr>
                        <td style="background:#c92f6d; border-radius:4px;">
