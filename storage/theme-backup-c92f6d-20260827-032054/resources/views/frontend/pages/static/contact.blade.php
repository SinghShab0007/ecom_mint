<style>
    ...
    .info-tile .ic{width:46px;height:46px;border-radius:50%;background:#c92f6d14;color:#c92f6d;display:flex;align-items:center;justify-content:center;font-size:20px;margin-bottom:14px;}
    ...
    .info-tile a{color:#c92f6d;text-decoration:none;}
    ...
    .form-control:focus{border-color:#c92f6d;box-shadow:0 0 0 3px #c92f6d1f;}
    .btn-send{background:#c92f6d;color:#fff;border:0;border-radius:9px;padding:12px 34px;font-weight:600;transition:.25s;}
            ...
            <div class="col-lg-7">
                <div class="contact-card" id="contact-form">
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Full Name <span style="color:#c92f6d;">*</span></label>
                                <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                       placeholder="Your name" required maxlength="100">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Email Address <span style="color:#c92f6d;">*</span></label>
                            ...
                            <div class="col-12">
                                <label class="form-label">Your Message <span style="color:#c92f6d;">*</span></label>
